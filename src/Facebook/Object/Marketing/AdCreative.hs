...
action_spec :: Has ActionSpec r => r -> ActionSpec_
action_spec r = r `Rec.get` ActionSpec
call_to_action :: Has CallToAction r => r -> CallToAction_
call_to_action r = r `Rec.get` CallToAction
place_page_set_id :: Has PlacePageSetId r => r -> PlacePageSetId_
place_page_set_id r = r `Rec.get` PlacePageSetId
value :: Has Value r => r -> Value_
value r = r `Rec.get` Value
image_file :: Has ImageFile r => r -> ImageFile_
image_file r = r `Rec.get` ImageFile
follow_redirect :: Has FollowRedirect r => r -> FollowRedirect_
follow_redirect r = r `Rec.get` FollowRedirect
object_instagram_id :: Has ObjectInstagramId r => r -> ObjectInstagramId_
object_instagram_id r = r `Rec.get` ObjectInstagramId
video_id :: Has VideoId r => r -> VideoId_
video_id r = r `Rec.get` VideoId
image :: Has Image r => r -> Image_
image r = r `Rec.get` Image
app_link :: Has AppLink r => r -> AppLink_
app_link r = r `Rec.get` AppLink
link_caption :: Has LinkCaption r => r -> LinkCaption_
link_caption r = r `Rec.get` LinkCaption
get_movie_showtimes :: Has GetMovieShowtimes r => r -> GetMovieShowtimes_
get_movie_showtimes r = r `Rec.get` GetMovieShowtimes
leadgen :: Has Leadgen r => r -> Leadgen_
leadgen r = r `Rec.get` Leadgen
link_description :: Has LinkDescription r => r -> LinkDescription_
link_description r = r `Rec.get` LinkDescription
sponsorship :: Has Sponsorship r => r -> Sponsorship_
sponsorship r = r `Rec.get` Sponsorship
application :: Has Application r => r -> Application_
application r = r `Rec.get` Application
video_annotation :: Has VideoAnnotation r => r -> VideoAnnotation_
video_annotation r = r `Rec.get` VideoAnnotation
start_time_in_sec :: Has StartTimeInSec r => r -> StartTimeInSec_
start_time_in_sec r = r `Rec.get` StartTimeInSec
policy_url :: Has PolicyUrl r => r -> PolicyUrl_
policy_url r = r `Rec.get` PolicyUrl
link :: Has Link r => r -> Link_
link r = r `Rec.get` Link
product_link :: Has ProductLink r => r -> ProductLink_
product_link r = r `Rec.get` ProductLink
end_time_in_sec :: Has EndTimeInSec r => r -> EndTimeInSec_
end_time_in_sec r = r `Rec.get` EndTimeInSec
page :: Has Page r => r -> Page_
page r = r `Rec.get` Page
fallback_test_url :: Has FallbackTestUrl r => r -> FallbackTestUrl_
fallback_test_url r = r `Rec.get` FallbackTestUrl
follow_up_action_url :: Has FollowUpActionUrl r => r -> FollowUpActionUrl_
follow_up_action_url r = r `Rec.get` FollowUpActionUrl
split_flow_use_post :: Has SplitFlowUsePost r => r -> SplitFlowUsePost_
split_flow_use_post r = r `Rec.get` SplitFlowUsePost
follow_up_title :: Has FollowUpTitle r => r -> FollowUpTitle_
follow_up_title r = r `Rec.get` FollowUpTitle
need_split_flow :: Has NeedSplitFlow r => r -> NeedSplitFlow_
need_split_flow r = r `Rec.get` NeedSplitFlow
tcpa_compliant :: Has TcpaCompliant r => r -> TcpaCompliant_
tcpa_compliant r = r `Rec.get` TcpaCompliant
follow_up_action_text :: Has FollowUpActionText r => r -> FollowUpActionText_
follow_up_action_text r = r `Rec.get` FollowUpActionText
landing_page_cta :: Has LandingPageCta r => r -> LandingPageCta_
landing_page_cta r = r `Rec.get` LandingPageCta
link_title :: Has LinkTitle r => r -> LinkTitle_
link_title r = r `Rec.get` LinkTitle
advanced_data :: Has AdvancedData r => r -> AdvancedData_
advanced_data r = r `Rec.get` AdvancedData
call_to_action_type :: Has CallToActionType r => r -> CallToActionType_
call_to_action_type r = r `Rec.get` CallToActionType
instagram_permalink_url :: Has InstagramPermalinkUrl r => r -> InstagramPermalinkUrl_
...
instance IsAdCreativeGetField ObjectStorySpec
...
instance IsAdCreativeSetField ObjectStorySpec
