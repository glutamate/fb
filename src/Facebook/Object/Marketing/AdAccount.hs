...
spend_cap_action :: Has SpendCapAction r => r -> SpendCapAction_
spend_cap_action r = r `Rec.get` SpendCapAction
business_info :: Has BusinessInfo r => r -> BusinessInfo_
business_info r = r `Rec.get` BusinessInfo
funding_id :: Has FundingId r => r -> FundingId_
funding_id r = r `Rec.get` FundingId
invoice :: Has Invoice r => r -> Invoice_
invoice r = r `Rec.get` Invoice
replace :: Has Replace r => r -> Replace_
replace r = r `Rec.get` Replace
io :: Has Io r => r -> Io_
io r = r `Rec.get` Io
adaccount_id :: Has AdaccountId r => r -> AdaccountId_
adaccount_id r = r `Rec.get` AdaccountId
po_number :: Has PoNumber r => r -> PoNumber_
po_number r = r `Rec.get` PoNumber
business_city :: Has BusinessCity r => r -> BusinessCity_
business_city r = r `Rec.get` BusinessCity
funding_source :: Has FundingSource r => r -> FundingSource_
funding_source r = r `Rec.get` FundingSource
has_migrated_permissions :: Has HasMigratedPermissions r => r -> HasMigratedPermissions_
has_migrated_permissions r = r `Rec.get` HasMigratedPermissions
business_country_code :: Has BusinessCountryCode r => r -> BusinessCountryCode_
business_country_code r = r `Rec.get` BusinessCountryCode
amount_spent :: Has AmountSpent r => r -> AmountSpent_
amount_spent r = r `Rec.get` AmountSpent
is_tax_id_required :: Has IsTaxIdRequired r => r -> IsTaxIdRequired_
is_tax_id_required r = r `Rec.get` IsTaxIdRequired
business_zip :: Has BusinessZip r => r -> BusinessZip_
business_zip r = r `Rec.get` BusinessZip
last_used_time :: Has LastUsedTime r => r -> LastUsedTime_
last_used_time r = r `Rec.get` LastUsedTime
min_daily_budget :: Has MinDailyBudget r => r -> MinDailyBudget_
min_daily_budget r = r `Rec.get` MinDailyBudget
business_state :: Has BusinessState r => r -> BusinessState_
business_state r = r `Rec.get` BusinessState
age :: Has Age r => r -> Age_
age r = r `Rec.get` Age
timezone_offset_hours_utc :: Has TimezoneOffsetHoursUtc r => r -> TimezoneOffsetHoursUtc_
timezone_offset_hours_utc r = r `Rec.get` TimezoneOffsetHoursUtc
business_street2 :: Has BusinessStreet2 r => r -> BusinessStreet2_
business_street2 r = r `Rec.get` BusinessStreet2
account_status :: Has AccountStatus r => r -> AccountStatus_
account_status r = r `Rec.get` AccountStatus
business_street :: Has BusinessStreet r => r -> BusinessStreet_
business_street r = r `Rec.get` BusinessStreet
end_advertiser_name :: Has EndAdvertiserName r => r -> EndAdvertiserName_
end_advertiser_name r = r `Rec.get` EndAdvertiserName
business_name :: Has BusinessName r => r -> BusinessName_
business_name r = r `Rec.get` BusinessName
tax_id_type :: Has TaxIdType r => r -> TaxIdType_
tax_id_type r = r `Rec.get` TaxIdType
owner :: Has Owner r => r -> Owner_
owner r = r `Rec.get` Owner
tax_id_status :: Has TaxIdStatus r => r -> TaxIdStatus_
tax_id_status r = r `Rec.get` TaxIdStatus
is_prepay_account :: Has IsPrepayAccount r => r -> IsPrepayAccount_
is_prepay_account r = r `Rec.get` IsPrepayAccount
balance :: Has Balance r => r -> Balance_
balance r = r `Rec.get` Balance
disable_reason :: Has DisableReason r => r -> DisableReason_
disable_reason r = r `Rec.get` DisableReason
is_personal :: Has IsPersonal r => r -> IsPersonal_
is_personal r = r `Rec.get` IsPersonal
min_campaign_group_spend_cap :: Has MinCampaignGroupSpendCap r => r -> MinCampaignGroupSpendCap_
min_campaign_group_spend_cap r = r `Rec.get` MinCampaignGroupSpendCap
user_role :: Has UserRole r => r -> UserRole_
user_role r = r `Rec.get` UserRole
offsite_pixels_tos_accepted :: Has OffsitePixelsTosAccepted r => r -> OffsitePixelsTosAccepted_
offsite_pixels_tos_accepted r = r `Rec.get` OffsitePixelsTosAccepted
io_number :: Has IoNumber r => r -> IoNumber_
io_number r = r `Rec.get` IoNumber
timezone_name :: Has TimezoneName r => r -> TimezoneName_
timezone_name r = r `Rec.get` TimezoneName
asset_score :: Has AssetScore r => r -> AssetScore_
asset_score r = r `Rec.get` AssetScore
tax_id :: Has TaxId r => r -> TaxId_
tax_id r = r `Rec.get` TaxId
vertical_name :: Has VerticalName r => r -> VerticalName_
