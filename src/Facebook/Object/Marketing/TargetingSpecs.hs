...
merge _ _ = error "attempting to merge non-Objects"

instance FromJSON TargetingSpecs where
    parseJSON val@(Object _) = genericParseJSON defaultOptions val
    parseJSON _ = error "cannot parse non-Object to TargetingSpecs"
